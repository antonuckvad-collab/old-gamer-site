    ...
    collections: [
      ...
      // ─── Предзаказы / Диски ─────────────────────────────────────
      {
        ...
        fields: [
          ...
          { type: "string", name: "release", label: "Статус / дата релиза", description: "Релиз: осень 2026 или В наличии · 3 шт." },
          {
            type: "string",
            name: "status",
            label: "Статус",
          ...
          { type: "string", name: "meta", label: "Жанр / студия", description: "Action · Open World · Rockstar" },
          { type: "image", name: "image", label: "Обложка игры", description: "600×800px, JPG/PNG, до 300KB" },
